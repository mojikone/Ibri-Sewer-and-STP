# -*- coding: utf-8 -*-
"""W4 methodology report -> PDF, rendered directly with reportlab (NO Word needed).
...
(report_content.build()). Re-run: python W4/report/make_methodology_pdf.py
"""
import os
...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                   "W4_Sewer_Network_Design_Methodology.pdf")
...
class Doc(BaseDocTemplate):
    ...
    def footer(self, canvas, doc):
        ...
        canvas.drawString(2.1 * cm, 1.2 * cm,
                          "Ibri 2621 — W4 Sewer Network Design Pipeline (internal)")
...
def build():
    ...
    doc = Doc(OUT, pagesize=A4, leftMargin=2.2 * cm, rightMargin=2.2 * cm,
              ...
              title="W4 Sewer Network Design Pipeline — Methodology",
