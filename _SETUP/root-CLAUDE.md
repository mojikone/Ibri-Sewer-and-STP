...
- Iterations: work in `Hydraulic/Claude/W#` folders — a rework request means create the next `W#`. Current latest: **W2**.
- Client data (`Data/`, `Hydraulic/Terrain/`, `Hydraulic/SHP/`) lives in this folder tree and is NOT in git — never move or modify it.
