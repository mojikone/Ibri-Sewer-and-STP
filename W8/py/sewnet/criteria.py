...
class Criteria:
    ...
    UNDERPASS_R_M: float = 30.0       # how close a crossing must be to count as free
    ...
    def ASSUMPTIONS(self) -> Dict[str, Tuple]:
        return {
            ...
            "CROSSING_COST": ((self.CROSS_PENALTY_M, self.CONNECT_PENALTY_M),
                              ...
                              "at a known underpass is charged nothing, but only "
                              "within 30 m of it — a 120 m radius let a crossing 97 m away "
                              "take the free pass (found by the user 2026-08-21)."),
