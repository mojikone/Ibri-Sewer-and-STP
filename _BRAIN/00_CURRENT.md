...
| `W13/shp/PLOTS_derived_class.shp` | every plot's main use derived from its meters (DERIVED, AGREE, WORKERS); the MoH `Classes` field is unreliable on metered plots 15 % of the time | 2026-09-09 |
