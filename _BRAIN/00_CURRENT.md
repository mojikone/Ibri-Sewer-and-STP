...
**2026-09-12 (later): every bend keeps its chamber.** The engineer's ruling on the drawing: a corner over 5° is never absorbed by a chamber 10 m away, two consecutive corners both stand, a head within 10 m of a bend moves onto it, a head pipe left under 10 m is removed and listed. Left on the boundary: 9 close pairs (sharp corner next to a junction), 28 offset heads, 10 removed head pipes. Next: pumps as candidates.
