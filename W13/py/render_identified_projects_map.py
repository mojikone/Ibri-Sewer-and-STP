...
OUT = "D:/Mojtaba/Renardet/2621 Ibri Sewer STP/Hydraulic/Claude/W13/img"
...
tb = proj.mapLayer('W13_test_boundary_8b516ac7_76da_4ddc_8225_03353c5a3c06')
...
render('W13_identified_projects_overview', QgsRectangle(421000, 2551500, 481000, 2588500), 3000, 1850, PTS,
       'Identified projects and special consumption, whole boundary (9 Sept 2026)', True)
# map 2: the town
render('W13_identified_projects_town', QgsRectangle(439000, 2559000, 459000, 2575500), 3000, 2475, PTS,
