...
MAIN_PIPE = BASE + r"\Hydraulic\Claude\REF_7SEPT\inputs\Main_Pipe_7sept.shp"   # the main pipe as drawn on 7 September, taken from the reference drawing
...
OUT = BASE + r"\Hydraulic\Claude\REF_7SEPT"
OUT_SHP = OUT + r"\shp"
OUT_DXF = OUT + r"\dxf"
OUT_IMG = OUT + r"\img"
OUT_RUN = OUT + r"\run"
