...
title = 'Settlements merged: people today and at ultimate (2073), the year each fills, sewage at ultimate. Plots: built by use, empty green = takes people'
...
p.end(); out = f"{W13}/img/W14_settlements_growth.png"; img.save(out); print('saved', out)
