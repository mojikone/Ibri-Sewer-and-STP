"""
W11b - TERRAIN FLOW ENGINE
==========================

The module W11b turns on.  W11a laid its network out on ROAD CONNECTIVITY and used the
...
WHAT IT PRODUCES  (all under W11b/run/terrain/)
...
def stage_streams(spec: GridSpec, force=False) -> dict:
    ...
    g["SRC"] = f"W11b terrain {spec.name} D8 {spec.res:.1f} m"
    del acc
...
def main(argv=None):
    import argparse
    ap = argparse.ArgumentParser(description="W11b terrain flow engine")
