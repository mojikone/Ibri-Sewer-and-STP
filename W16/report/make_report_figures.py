...
def d3_flow():
    ...
    c.node("inf", 0, 2, "Infiltration|720 l/d per km|sizing case only")
    c.node("pk", 2, 2, "Peak factor per pipe:|Merrimack over 100 properties,|Peltier 100 or fewer")
...
def d6_landuse():
    ...
    c = Chart(3, 5, cw=268, rh=126, gx=40, gy=30,
