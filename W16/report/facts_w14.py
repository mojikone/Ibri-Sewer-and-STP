...
# W16 reads the load layers and the growth workbook where they were made and frozen:
# W14/. Nothing in the load chain changed in W16; when it does, W16 gets its own shp/
# and analysis/ and this points there.
