...
def _r2_layers():
    ...
    W14 = os.path.join(REPO, "W14")          # the load layers are frozen in W14/shp
...
def _fill_box(lay, rows, width=None):
    """Write the figure's data table and hinge it to the lower-right corner. width: mm,
    for a box whose text needs more than the template's 58 mm."""
