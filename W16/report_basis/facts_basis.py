...
def boxes():
    ...
    out = {
        ...
        "B02_landuse": [["Built plots with meters", fmt(ps["metered"])], ["Residential", fmt(cls.get("Residential", 0))],
                        ["Commercial", fmt(cls.get("Commercial", 0))], ["Residential-Commercial", fmt(cls.get("Residential-Commercial", 0))],
                        ["Government", fmt(cls.get("Government", 0))], ["Agricultural", fmt(cls.get("Agricultural", 0))],
