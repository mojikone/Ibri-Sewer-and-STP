...
ITEMS = [
    ...
    ("analysis/settlements_today.csv", "02_tables", "Per settlement: people 2024, occupancy, properties per home plot, home share, meters, water and sewage by stream, unit rates per meter, capacity"),
    ...
    ("shp/PLOTS_load.*", "03_gis", "Every plot (56 fields): meters by tariff and category, use, the settlement rates and unit rates, people, water and sewage by stream, QADF, and people and flow in 2030 / 2055 / saturation"),
    ("shp/ELE_meters_on_plots.*", "03_gis", "Every electricity meter with its category, its plot and its settlement"),
    ("shp/Settlements_merged.*", "03_gis", "The 25 settlements as a partition (69 fields): derived and adopted rates, meters, shares and unit rates, five-year people and flow, saturation with and without overflow, people sent and received"),
