"""W14 copy of W9/py/make_appraisal_figure.py (W9 is frozen): the STEP 9 label no longer overflows its box.
...
def appraisal():
    ...
    c.node("s9", 4, 4, "STEP 9|RECOMMENDED|OPTION|one per system",
           "accent")
