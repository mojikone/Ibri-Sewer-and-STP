...
# ======================================================= 10. PUMPING
def s10_pumping(d):
    D.h(d, 1, "11   Lifting stations and force mains", page_break=True)

    D.h(d, 2, "16.1   Purpose")
    ...
    D.h(d, 2, "16.2   When a station is required")
    ...
    D.h(d, 2, "16.3   Station classification")
    ...
    D.h(d, 2, "16.5   Suction conditions")
    eq = D.next_eq()
    ...
    D.h(d, 2, "16.8   Emergency provision")
...
# ======================================================= 11. STP
def s11_stp(d):
    D.h(d, 1, "16   Treatment plant sizing and phasing", page_break=True)

    D.h(d, 2, "16.1   Purpose")
    D.p(d, "Converting flows and loads into a plant capacity, a technology, a "
           "land area and a phasing plan.")

    D.h(d, 2, "16.2   Size categories, and why they matter")
    ...
    D.h(d, 2, "16.3   Design horizon and margin")
    ...
    D.h(d, 2, "16.4   Influent characterisation")
    ...
    D.h(d, 2, "16.5   Load, and an equation the guideline does not print")
    ...
    D.h(d, 2, "16.9   Siting and buffer")
...
# ======================================================= 12. TSE
def s12_tse(d):
    D.h(d, 1, "17   Treated effluent", page_break=True)

    D.h(d, 2, "17.1   How much is produced")
    eq = D.next_eq()
    ...
    D.h(d, 2, "17.3   How much each needs")
    ...
    D.h(d, 2, "17.4   Seasonality and sizing")
...
# ======================================================= 13. SLUDGE
def s13_sludge(d):
    D.h(d, 1, "18   Sludge", page_break=True)
...
# ======================================================= 14. APPRAISAL
def s14_appraisal(d):
    D.h(d, 1, "21   Options and the recommendation", page_break=True)

    D.h(d, 2, "21.1   How many options, and of what kind")
    ...
    D.h(d, 2, "21.2   The appraisal parameters")
    ...
    D.h(d, 2, "21.3   Cost and carbon")
    D.p(d, "Cost estimation is Section 19 and the appraisal itself is Section "
           "20. In summary, each option carries a capital cost by phase, an "
           "operating cost by year, a net present value at 5 per cent over 25 "
           "years, and a carbon footprint in tonnes of carbon dioxide "
           "equivalent per year and per cubic metre against the benchmark. One "
           "option must include a carbon reduction plan comparing a "
           "conventional base case with an optimised scenario.")

    D.h(d, 2, "21.4   Choosing")
    ...
    D.h(d, 2, "21.5   Value engineering")
...
# ======================================================= 15. RELIABILITY
def s15_defects(d):
    D.h(d, 1, "22   Where the guidelines cannot be relied on", page_break=True)
    ...
    D.h(d, 2, "22.1   Formulae that do not exist in the guidelines")
    ...
    D.h(d, 2, "22.2   A mandatory method that cannot be completed")
    ...
    D.h(d, 2, "22.3   Errors of substance")
    ...
    D.h(d, 2, "22.4   Cross-references that do not resolve")
    ...
    D.h(d, 2, "22.5   What to do about all this")
