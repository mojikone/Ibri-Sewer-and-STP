...
def cover(d):
    ...
    D.p(d, "Tutorial T03  ·  " + REV, align=AL.CENTER, bold=True, size=13, colour=D.MID)
    D.p(d, "", space_after=30)
    ...
    D.p(d, "Project 2621   ·   Revision 01   ·   August 2026",
    ...
    D.table(d,
            ...
            [["Understand the whole chain in twenty minutes",
             ...
             ["Know where the guidelines are wrong or silent",
              "Section 22, and the caution boxes throughout"]],
...
def executive_summary(d):
    ...
    D.p(d, "The concept design turns a population into a set of pipe diameters, "
           ...
           "nineteen steps, and fixes every number to a page of a guideline. What "
    ...
    # ---------------------------------------------------------------- chain
    D.h(d, 2, "The chain, step by step")
    ...
    D.p(d, "Steps 1 to 6 are one continuous calculation: each is the input to "
           "the next, and an error early on propagates the whole way. Steps 7 "
           "to 16 consume that flow, largely independently of one another. "
           "Steps 17 to 19 sit across all of them and decide what gets built.")
