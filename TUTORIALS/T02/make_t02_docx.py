# -*- coding: utf-8 -*-
"""T02 tutorial -> Word (.docx), rendered from the shared content blocks.
...
OUT = os.environ.get("T02_DOCX_OUT") or os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "T02_Hydraulic_Design_of_a_Gravity_Sewer.docx")
