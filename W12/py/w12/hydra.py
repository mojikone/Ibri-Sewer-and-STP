"""w12.hydra - the hydraulics. Colebrook-White on the TRUE INTERNAL BORE, Table 11, the
...
changed  (1) THE TABLE 11 GATE IS A HARD IMPORT-TIME ASSERTION, not a test file somebody
             ...
             than TABLE11_TOL. Measured deviation is printed by `python -m w12.hydra`.
...
def _self_test(verbose: bool = True) -> None:
    ...
    # and W12 works consistently in m3/s with the 3-significant-figure constant.
