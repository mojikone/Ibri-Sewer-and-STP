...
REPO = os.path.dirname(W12)
BASE = os.path.dirname(os.path.dirname(REPO))

EXPORT = os.path.join(W12, "shp", "W12_export.gpkg")
FLOWS = os.path.join(W12, "shp", "W12_flows.gpkg")
PLOTS = os.path.join(REPO, "W10", "shp", "W10_plot_loads.gpkg")
KMZ = os.path.join(W12, "kmz", "W12_overview.kmz")
DXF = os.path.join(W12, "dxf", "W12_overview.dxf")
...
PUMPS = os.path.join(W12, "shp", "W12_pumps.gpkg")
HIER = os.path.join(W12, "shp", "W12_hier.gpkg")
LEVELS = os.path.join(W12, "shp", "W12_levels.gpkg")
